      ...
      >
        ...
        <div className="state state--default">
          <div className="icon">
            ...
            >
              <g style={{ filter: "url(#shadow-send)" }}>
                <path
        ...
        <div className="state state--sent">
          <div className="icon">
            ...
            >
              <g style={{ filter: "url(#shadow-sent)" }}>
                ...
                <path
                  fill="currentColor"
                  d="M10.5795 15.5801C10.3795 15.5801 10.1895 15.5001 10.0495 15.3601L7.21945 12.5301C6.92945 12.2401 6.92945 11.7601 7.21945 11.4701C7.50945 11.1801 7.98945 11.1801 8.27945 11.4701L10.5795 13.7701L15.7195 8.6301C16.0095 8.3401 16.4899 8.3401 16.7795 8.6301C17.0699 8.9201 17.0699 9.4001 16.7799 9.6901L11.1095 15.3601C10.9695 15.5001 10.7795 15.5801 10.5795 15.5801Z"
                />
              </g>
          ...
          <p>
            {"Sent".split("").map((letter, index) => (
              <span key={index} style={letterStyle(index + 5)}>
                {letter}
              </span>
            ))}
          </p>
...
const StyledWrapper = styled.div`
  ...
  .button:hover p span {
    ...
    animation:
      wave 0.5s ease forwards
      calc(var(--i) * 0.02s);
  }

  /*
   * IMPORTANT:
   * React state controls the sent animation.
   * No :focus is used for the sent state.
   */
